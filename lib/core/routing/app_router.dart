...
class AppRouter {
  Route generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case Routes.search:
        return AnimationRoute(page: const SearchScreen());
      ...
      case Routes.myProfile:
        return AnimationRoute(page: const MyProfileScreen());
      case Routes.yourOrder:
        return AnimationRoute(page: const YourOrderScreen());
      case Routes.addresses:
        return AnimationRoute(page: const AddressesScreen());
      case Routes.changePassword:
        return AnimationRoute(page: const ChangePasswordScreen());
